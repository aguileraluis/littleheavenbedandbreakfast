...
import InfoSection9 from '../components/InfoSection9';
...
const Ourstoryscreen = () => {
  return (
    <div style={{backgroundColor: 'orange'}}>
        ...
        <br/>
        <TextSection paragraph="The story of how Little Heaven Bed & Breakfast came into existence is one of Faith. Jonathan and Maria met each other in February 2016. They knew right away that they were meant to be together. By June 2016 they were married. Maria had 4 daughters and Jonathan had 2 daughters when they first met. Neither of them had much growing up or really even when they met each other, but God changed all of that for them once they were together. They bought a few properties to try and do short term rentals and it really took off."/>
     
        <InfoSection9 {...InfoDataTen}/>
    
        <TextSection paragraph="They started traveling and seeing what was out there and enjoyed it. One day while they were on vacation at Pigeon Forge Tennessee on Christmas Season, they had the thought about having their own bed and breakfast. They went to a couple of Bed & Breakfasts' to experience it and they fell in love with the idea of having their very own Bed & Breakfast. They sold two investment properties and their very first house to open what is now known as Little Heaven Bed & Breakfast. They looked and prayed for several months to find the place until they found 'TUCKDA WAY'. When they saw this place they immediately knew that it was THE ONE! The name LITTLE HEAVEN came for the beautiful views of mountains, blue heaven and the feel in the atmosphere of the green forest and of course the amazing views of so many acres of vine of wineries. They started the process of the bed and breakfast and thought that it was going to be a quick process to remodel and open Little Heaven but boy were they wrong. They bought the Cabin with 10 acres of land and a pond in December 2021. With many challenges and shortages of labor it took much longer than they thought. Each step of the way they relied on God and their Faith that it was all part of his plan to take this long. One thing that Jonathan and Maria Hunt have always held strong to is their Faith through it all. That is why each room is named after the things that God spoke about in the Bible."/>
        <br/>
      ...
      <InfoSection9 {...InfoDataEleven}/>
      <TextSection paragraph="We deeply thank you for your business and for choosing to stay with us. You will absolutely love your stay."/>
